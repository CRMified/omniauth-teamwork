	...
	describe "callback phase" do
		...
		before do
			raw_info = {
				...
				'urls'=> {
					"enterprise" => "https://teamwork.example/services",
					"metadata" => "https://teamwork.example/services"
				}
			}
			client = OAuth2::Client.new 'id', 'secret', {:site => 'example.com'}
			access_token = OAuth2::AccessToken.from_hash client, {
				'access_token' => 'token',
				'instance_url' => 'http://instance.teamwork.example',
				'signature' => 'invalid',
		...
		describe "user id validation" do
			...
			instance_url = 'http://instance.teamwork.example'
			before do
					client_id = "https://login.teamwork.com/id/00Dd0000000d45TEBQ/005d0000000fyGPCCY"
